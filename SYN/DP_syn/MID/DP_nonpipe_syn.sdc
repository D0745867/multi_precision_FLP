...
# Created by write_sdc on Wed Nov 30 22:52:56 2022
...
sc9_cln40g_base_rvt_ss_typical_max_0p81v_125c
create_clock -name clk  -period 9.25  -waveform {0 4.625}
set_max_delay 9.25  -from [list [get_ports {x1[31]}] [get_ports {x1[30]}] [get_ports {x1[29]}]    \
